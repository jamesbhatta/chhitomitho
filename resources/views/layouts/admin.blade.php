    ...
    <div class="d-flex">
        <div class="side px-4">
            ...
            <ul class="list-unstyled sidebar-list">
                ...
                <li class="sidebar-list-item">
                    <a class="nav-link" href="{{ route('category.index') }}"><i class="fas fa-th-large"></i>Products<span><i class="fas fa-angle-right"></i></span></a>
                </li>
                <li class="sidebar-list-item">
                    <a class="nav-link" href=""><i class="far fa-copy"></i>Pages<span><i class="fas fa-angle-right"></i></span></a>
                </li>
                <li class="sidebar-list-item">
                    <a class="nav-link" href=""><i class="fas fa-toolbox"></i>UI Kit<span><i class="fas fa-angle-right"></i></span></a>
                </li>
                <li class="sidebar-list-item">
