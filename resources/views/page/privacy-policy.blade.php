...
<div class="container white my-5 p-4">
    ...
    <ul>
        ...
        <li>
            <p><strong>Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to Mohrain WebSoft, Kailalipool, Dhangadhi.</p>
        </li>
        <li><strong>Affiliate</strong> means an entity that controls, is controlled by or is under common control with a party, where "control" means ownership of 50% or more of the shares, equity interest or other securities entitled to vote for election of directors or other managing authority.</li>
        <li><strong>Account</strong> means a unique account created for You to access our Service or parts of our Service.</li>
        <li><strong>Website</strong> refers to Chhitomitho, accessible from https://chhitomitho.com</li>        <li><strong>Service</strong> refers to the Website.</li>
    ...
    <ul>
        ...
        <ul>
            <li>By email: info@chhitomitho.com</li>
            <li>By phone number: 9865720910</li>
        </ul>
    </div>
    @endsection